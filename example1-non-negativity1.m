...
subplot(3,1,1);
plot(t(1:1:20),T_ee(1:1:20));
title('Load of Target CD4-cells (Explicit Eulerian Scheme, h = 1)');
xlabel('t [days]');
ylabel('T(t)','interpreter','tex');

subplot(3,1,2);
plot(t(1:1:15),T_rk2(1:1:15));
title('Load of Target CD4-cells (Second-Order Runge-Kutta Scheme, h = 1)');
xlabel('t [days]');
ylabel('T(t)','interpreter','tex');
...
subplot(3,1,3);
plot(t,T_nsfdm);
title('Load of Target CD4-cells (Non-Standard Finite-Difference-Method, h = 1)');
xlabel('t [days]');
ylabel('T(t)','interpreter','tex');
yticks([0 4 8 12]);
